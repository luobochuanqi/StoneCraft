...
import xyz.luobochuanqi.StoneCraft.Register.BlockRegister;
import xyz.luobochuanqi.StoneCraft.Register.MenuRegister;
...
public class CrusherMenu extends AbstractContainerMenu {
    private final CrusherEntityBlock blockEntity;
    ...
    public CrusherMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MenuRegister.CrusherMenu.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((CrusherEntityBlock) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockRegister.StoneCrusher.get());
    }
